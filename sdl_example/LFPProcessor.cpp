...
LFPBuffer::LFPBuffer(TetrodesInfo* tetr_info, const unsigned int& pop_vec_win_len, const unsigned int& sampling_rate)
...
int* Utils::Math::GetRange(const unsigned int& from, const unsigned int& to){
